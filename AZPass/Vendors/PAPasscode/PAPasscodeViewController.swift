...
//        }
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(PAPasscodeViewController.keyboardWillShow(_:)), name: UIResponder.keyboardWillChangeFrameNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(PAPasscodeViewController.keyboardWillHide(_:)), name: UIResponder.keyboardWillHideNotification, object: nil)
